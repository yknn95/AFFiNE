...
const useImageBlob = (
  ...
  const { data, error, isLoading } = useSWR(
    ...
    {
      fetcher: async ([_, __, pageId, blockId, useOriginal]) => {
        ...
        // Prefer original image for high-resolution viewing in fullscreen
        const sourceId = (useOriginal && blockModel.props.originalSourceId)
